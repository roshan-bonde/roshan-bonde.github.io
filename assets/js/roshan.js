/*-----------------------------------------------------------
* Template Name    : Roshan Bonde - Fully Responsive Personal Website
* Author           : Roshan Bonde
* Version          : 1.0.0
...
function  menuToggler() {
    ...
    $menuToggler.click(function () {
        $(this).toggleClass('open').find('i').toggleClass('ri-menu-fold-line ri-menu-unfold-line');
    ...
    if ($window.width() < 1200){
        $('header li a').click(function () {
            ...
            $('.color-scheme, .pallet-button, .color-pallet').toggleClass('hide');
            $menuToggler.removeClass('open').find('i').removeClass('ri-menu-fold-line').addClass('ri-menu-unfold-line');
        })
    }
}
/*-------------------------
